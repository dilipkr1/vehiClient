      ...
      <div className="">
        <div className="topSec bg-logoClr">
          <div className="py-20 lg:px-20 headingShop text-white text-4xl font-roboto">
            ...
            <h2 className="text-white headMob mx-auto lg:2xl text-xl tracking-wider">
              Vehismart Private Limited
            </h2>
          </div>
        </div>
        ...
        <div className="container mx-auto py-8 px-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <h2 className="text-xl font-semibold mb-4">
              Welcome to Vehismart Private Limited!
            </h2>
            <div>
              <h2 className="text-xl font-semibold mb-4">Who We Are</h2>
              <p className="text-pgcolor">
                At Vehismart, we're not just in the business of car cleaning;
            ...
            <div>
              ...
              <p className="text-pgcolor">
                ...
                Vehismart, you can rest assured that your car will sparkle
            ...
            <div>
              ...
              <p className="text-pgcolor">
                Vehismart is more than just a car cleaning service; we're on a
            ...
            <div>
              ...
              <p className="text-pgcolor">
                When you choose Vehismart, you're not just choosing a service;
            ...
            <div>
              ...
              <strong>
                Join us in experiencing the Vehismart difference – where your
        ...
        <footer className="bg-gray-800 text-logoClr py-4">
          <div className="container mx-auto text-center">
            {/* <p>
              &copy; {new Date().getFullYear()} Vehismart Private Limited. All
              rights reserved.
            </p> */}
          </div>
        </footer>
